<h1>Herb Identification Game</h1>
...
Optional hint system with reduced scoring

Tracks score across all rounds

Shows herb details when the user is out of chances
...
Images are expected to be stored in the project under:

/images/<herb_name_in_lowercase>.png


Example:
tulsi.png, mint.png

The GUI is built using Java Swing with a simple layout:

Top: Displays the herb image

Center: Input field and buttons
